...
description: >-
  ...
  or when a feature is too large for a single Codex session. Produces a plan where each step
...
Large features can't be completed in a single Codex session. This skill decomposes a high-level objective into a sequenced plan where each step:
...
### Cold-Start Brief
> A fresh Codex session should read ONLY this section to begin work.
