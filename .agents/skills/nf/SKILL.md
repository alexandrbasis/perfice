...
Before asking deep-dive questions, read `.Codex/docs/templates/discovery-template.md` to understand the expected structure, level of clarity, and final shape of the discovery document.
...
1. **Re-read template if needed**: Review `.Codex/docs/templates/discovery-template.md` to confirm the expected structure and clarity level
...
Format output per `.Codex/docs/templates/cross-ai-protocol.md` (comparison table, validation, verdict).
