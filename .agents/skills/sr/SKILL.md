...
- `working-tree` -> `.Codex/reviews/code-review-working-tree-[current-branch].md` (or `code-review-working-tree.md` if detached)
- all other non-task modes -> `.Codex/reviews/code-review-[target].md` (create `.Codex/reviews/` if missing)
...
**If no file exists at all**: create it by writing the template from `.Codex/docs/templates/code-review-template.md`.
