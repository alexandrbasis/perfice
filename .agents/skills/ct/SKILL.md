...
- Before drafting, read `.Codex/docs/templates/technical-decomposition-template.md`
...
For **Complex** plans, cross-AI validation is part of the required review path. Follow `.Codex/docs/templates/cross-ai-protocol.md` if present.
